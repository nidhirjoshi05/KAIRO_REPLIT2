...
import { Home, BookOpen, MessageCircle, Users, AlertCircle, Stethoscope, User, Settings as SettingsIcon, LogOut, Sparkles, Calendar, BookText } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <nav className="border-b bg-card sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <img src={kairoLogo} alt="Kairo" className="w-10 h-10" data-testid="img-logo" />
              <div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="home" className="space-y-6">
            ...
            >
              ...
              {!hasCompletedEQ && (
                <div>
                  <h3 className="text-xl font-semibold mb-4" data-testid="text-eq-section">Complete Your EQ Assessment</h3>
                  <EQAssessment
                    onComplete={() => setHasCompletedEQ(true)}
                    canRetake={false}
                    hasCompleted={false}
                  />
                </div>
              ...
              {hasCompletedEQ && (
                <div className="text-center p-8 bg-primary/5 rounded-lg">
                  <p className="text-lg" data-testid="text-eq-completed">
                    Assessment completed! Upgrade to Pro to track your progress over time.
                  </p>
                  <Button onClick={handleUpgrade} className="mt-4" data-testid="button-upgrade-eq">
                    Upgrade to Pro
                  </Button>
                </div>
              )}
          ...
          <TabsContent value="consultations" className="space-y-6">
            <div className="mb-4">
              ...
              <Card className="p-6 bg-primary/5" data-testid="card-free-session">
                ...
                <Button data-testid="button-book-free">Book Your Free Session</Button>
              </Card>
            </div>
