...
import { Home, BookOpen, MessageCircle, Users, AlertCircle, Stethoscope, Heart, User, Settings as SettingsIcon, LogOut, TrendingUp, Award, Target, Calendar, BookText } from 'lucide-react';
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="home" className="space-y-6">
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-semibold mb-4" data-testid="text-eq-section">Track Your Progress</h3>
                <EQAssessment onComplete={(score) => console.log('New EQ score:', score)} canRetake={true} />
              </div>
            </motion.div>
          </TabsContent>
              ...
              <>
                {!showMatching && (
                  <Card className="p-6 bg-gradient-to-br from-primary/10 to-primary/5" data-testid="card-get-matched">
                    ...
                    <Button onClick={() => setShowMatching(true)} data-testid="button-start-matching">
